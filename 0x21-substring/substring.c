 ...
 *                  substrings containing a list of words,
 *                  within a given string.
 * 
 * @s: the string to scan
 * @words: the array of words all substrings must be a 
 ...
 *          at which a substring was found. If no solution
 *          is found, NULL can be returned
 */
